...
from src.serie_text.queries import get_mode_query, get_alpha_query, get_whitespace, get_lowercase, get_uppercase, get_digit, get_missing_query
...
class TextColumn:
    ...
    def set_empty(self):
        ...
        """
        self.n_empty = self.serie.isna().sum()
